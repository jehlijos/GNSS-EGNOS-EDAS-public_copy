...
# GSV
# GST
# AUTONOMOUS GNSS RECIEVER, PORT SYMBOLIC LINK: topblue, RECIEVER =1 
...
reciever = 1  # ID by type of reciever (EGNOSxEDAS)
i = 0
i_gsa = 0
i_gsv = 0
egnos = 0
...
with serial.Serial("/dev/topblue", 38400, timeout=1) as ser:
